...
import { Camera, Check, CheckCircle, CheckCircle2, Upload, X } from "lucide-react";
            ...
            <div className="grid grid-cols-2 gap-4 max-w-2xl mx-auto">
              {specialties.map((specialty) => (
                <button
                  ...
                  disabled={!!selectedSpecialty && selectedSpecialty !== specialty}
  ...
  return (
    <div className="h-full flex flex-col justify-between">
      ...
      <div className="flex border-t border-gray-500 px-10 pt-10 items-center justify-between">
        ...
        <Button
          onClick={handleNext}
          className="rounded-full px-6 border-4 bg-[#955aa4] text-white text-xl font-bold border-[#955aa4] uppercase hover:bg-[#955aa4]/90"
        >
          {currentStep === profileSteps.length - 1 ? "Done" : "Next"}
        </Button>
      </div>
              ...
              <div className="bg-white rounded-2xl shadow-2xl p-8 max-w-lg w-full">
                <div className="space-y-6">
                  <div className="text-center">
                    <h3 className="text-2xl font-bold text-gray-900 mb-2">Edit Photo</h3>
