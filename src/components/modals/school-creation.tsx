                    ...
                    <div className="flex flex-wrap gap-3">
                      {schoolTypes.map((type) => (
                        <button
                          ...
                          className={`px-5 py-2.5 rounded-xl font-medium text-sm transition-all duration-200 ${formData.type === type
                            ...
                            <div className="max-h-48 overflow-y-auto p-2">
                              {campusOptions.map((campus) => (
                                <button
                                  ...
                                  className={`w-full text-left px-4 py-2.5 rounded-lg flex items-center justify-between transition-colors ${selectedCampuses.includes(campus)
