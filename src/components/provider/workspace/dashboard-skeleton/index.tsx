 ...
 * (`rounded-xl`, translucent border, backdrop blur), a 3-slot top row (NEW /
    ...
    <div className="grid grid-cols-2 gap-4 max-[480px]:grid-cols-1 min-[900px]:grid-cols-4">
      {Array.from({ length: 12 }).map((_, i) => (
        <m.div
          ...
          className="bg-card flex w-full flex-col items-center gap-1 rounded-xl border border-[rgba(255,255,255,.14)] px-[clamp(10px,1vw,16px)] pt-[clamp(11px,1.5vh,16px)] pb-[clamp(13px,1.8vh,19px)] text-center shadow-[0_14px_34px_rgba(0,0,0,.35)] backdrop-blur-[12px] backdrop-saturate-[1.2]"
        >
